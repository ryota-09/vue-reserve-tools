...
export default new Vuex.Store({
  ...
  state: {
    ...
    toolList: [
      ...
      new Tool(2, "iPhone", "", new ReserveState(false, 0, 0, 0)),
      new Tool(3, "プロジェクター", "", new ReserveState(true, 2, 9, 10)),
      new Tool(4, "スクリーン", "", new ReserveState(false,0,  0, 0)),
      new Tool(5, "軽トラック", "", new ReserveState(true, 4, 15, 17)),
      new Tool(6, "大型車", "", new ReserveState(false, 0, 0, 0)),
      new Tool(7, "Webカメラ", "", new ReserveState(true, 2, 12, 14)),
      new Tool(8, "横断幕", "", new ReserveState(false, 0, 0, 0)),
    ],
    isLogedIn: false 
  },
  actions: {
